...
contract Twitter {
    ...
    function likeTweet (address author, uint256 id) external  { 
        //handle if someone try to break contract with wrong author and id
    ...
    function unLikeTweet (address author, uint256 id) external  { 
        //handle if tweet not exist
        require(tweets[author][id].id == id, "TWEET DOES NOT EXIST");

        // handle nagetive likes
        require(tweets[author][id].likes > 0, "TWEET HAS NO LIKEST");
