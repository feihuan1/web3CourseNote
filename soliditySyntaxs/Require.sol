...
contract Twitter {
    ...
    // define as constance so that value cant be changed
    ...
    function createTweet(string memory _tweet) public {
        ...
        // one char = 1 byte, conver _tweet to byte and get length
        // if tweet longer than 280, it will go out of this whole function
