...
contract Twitter {
    ...
    // constructor only runs at the moment deploy the contract, so msg.owner is the creator of contract
    constructor() {
        owner = msg.sender;
    }

    // this msg owner is someone call function with this modifier, not original owner
    modifier onlyOwner () {
